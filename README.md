...
important file in the project is "usage_permit_request.bpmn" without 
any java code manage the workflow.  
...
<!-- HTML snippet for index page
  <tr>
    <td><img src="snippets/camunda-servlet/src/main/resources/process.png" width="100"></td>
    <td><a href="snippets/camunda-servlet">Camunda BPM Process Application</a></td>
    <td>A Process Application for [Camunda BPM](http://docs.camunda.org).</td>
  </tr>
-->
<!-- Tweet
New @Camunda example: Camunda BPM Process Application - A Process Application for [Camunda BPM](http://docs.camunda.org). https://github.com/camunda-consulting/code/tree/master/snippets/camunda-servlet
-->